...
d9 = Drift(l=3.170805021285002, eid='D9')
d10 = Drift(l=2.2613439952228953, eid='D10')
d11 = Drift(l=3.4296093233859164, eid='D11')
d12 = Drift(l=1.8971473842710345, eid='D12')
d13 = Drift(l=1.0520521858741516, eid='D13')
d14 = Drift(l=8.343070258787405, eid='D14')
d15 = Drift(l=9.597417791741258, eid='D15')
d16 = Drift(l=8.444705983181585, eid='D16')
d17 = Drift(l=3.532073340095209, eid='D17')
d18 = Drift(l=2.810057150463483, eid='D18')
d19 = Drift(l=3.5620064699442815, eid='D19')
d20 = Drift(l=2.4518427566566308, eid='D20')
d21 = Drift(l=1.6850285259537305, eid='D21')
d22 = Drift(l=15.013045174029305, eid='D22')
d23 = Drift(l=3.5276016357373434, eid='D23')
...
qh2887t8 = Quadrupole(l=1.0291, k1=-0.1857595854101905, eid='QH2887T8')
qh2890t8 = Quadrupole(l=1.0291, k1=0.3251593348727915, eid='QH2890T8')
qh2892t8 = Quadrupole(l=1.0291, k1=-0.0851800237732437, eid='QH2892T8')
qf2906t8 = Quadrupole(l=0.5321, k1=0.46729486288084854, eid='QF2906T8')
qf2911t8 = Quadrupole(l=0.5321, k1=-0.15438510092117982, eid='QF2911T8')
qf2920t8 = Quadrupole(l=0.5321, k1=-0.16709860327665246, eid='QF2920T8')
qf2925t8 = Quadrupole(l=0.5321, k1=0.3668290342304753, eid='QF2925T8')
qh2941t8 = Quadrupole(l=1.0291, k1=-0.39183890443103103, eid='QH2941T8')
qh2944t8 = Quadrupole(l=1.0291, k1=0.36773683358144693, eid='QH2944T8')
qh2946t8 = Quadrupole(l=1.0291, k1=-0.27466209914346146, eid='QH2946T8')
qf2955t8 = Quadrupole(l=0.5321, k1=0.39350138499921694, eid='QF2955T8')
qf2961t8 = Quadrupole(l=0.5321, k1=-0.3389454174150529, eid='QF2961T8')
qf2981t8 = Quadrupole(l=0.5321, k1=0.40024202062892117, eid='QF2981T8')
qf2987t8 = Quadrupole(l=0.5321, k1=-0.26150499722014064, eid='QF2987T8')
...
be2899t8 = SBend(l=2.50003, angle=0.0359669889267619, eid='BE2899T8')
be2935t8 = SBend(l=2.50003, angle=-0.0185504, eid='BE2935T8')
be2953t8 = SBend(l=2.50003, angle=-0.018668689999999998, eid='BE2953T8')
